// "Melhor de X" (best-of-X) — quantas partidas (jogos individuais) uma
// mesa/rodada pode ter até decidir o vencedor. Valores em sincronia com o
// enum `FormatoMD` do backend (ver docs/PARTIDAS.md).
