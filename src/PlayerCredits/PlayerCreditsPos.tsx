...
export default function PlayerCreditsPos() {
  ...
  const [selectedPlayer, setSelectedPlayer] =
      useState<JogadorLojaPublico | null>(null);
      ...
      cartItems.forEach((product) => {
          ...
          if (stockProduct) {
              const novaQuantidade =
                  stockProduct.quantidade - product.quantidade;
                      ...
                      <div className="bg-white rounded-lg shadow p-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              ...
                              <input
                                  ...
                                  value={awardCredits}
                                  onChange={(e) =>
                                      setAwardCredits(e.target.value)
                                  }
                                  placeholder="R$"
                                  className="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-600"
                              />
                      ...
                      <div className="bg-white rounded-lg shadow p-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              <select
                                  ...
                                  onChange={(e) =>
                                      setRemoveCrPlayer(e.target.value)
                                  }
                              >
                                  <option value="">Jogador</option>
                                  {players?.map((player) => (
                      ...
                      {selectedPlayer && (
                          <div className="mt-4 p-4 bg-gradient-to-br from-purple-600 to-pink-600 rounded-lg text-white">
                              ...
                              <p className="text-3xl">
                                  ${selectedPlayer.creditos.toFixed(2)}
                              </p>
                          </div>
                      )}
                  </div>
                      ...
                      {cartItems.length === 0 ? (
                          <div className="text-center py-8 text-gray-500">
                              ...
                              <p className="text-xs mt-1">
                                  Selecione um jogador e adicione produtos
                              </p>
                          </div>
                      ) : (
                          <>
