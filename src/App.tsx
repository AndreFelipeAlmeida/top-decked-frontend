      ...
      <>
        <Routes>
            ...
            <Route element={<ProtectedRoutes allowedRoles={["loja"]} />}>
                ...
                <Route
                    path="/loja/rankings"
                    element={<OrganizerRankings />}
                />
                <Route
                    path="/loja/criar-torneio"
                ...
                <Route
                    path="/loja/creditos"
                    element={<PlayerCreditsPos />}
                />
                <Route
                    path="/loja/regras-jogadores"
                    element={<PlayerRules />}
                />
                <Route
                    path="/loja/torneio/:id/configurar"
